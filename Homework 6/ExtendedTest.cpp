...
{
    Bag b;
    assert(b.mostFrequent()==NULL_TCOMP);
    b.add(1);
    b.add(2);
    b.add(3);
    b.add(4);
    ...
    b.add(15);
    b.add(15);
    assert(b.mostFrequent()==15);
    b.add(4);
    b.add(4);
    assert(b.mostFrequent()==4);
}
...
void testAllExtended() {
	...
	testCustom();
	std::cout<<"Done with custom!";
	testAdd();
	std::cout<<"Done with add!";
	//testRemove();
	//std::cout<<"Done with remove!";
	//testIterator();
	//std::cout<<"Done with iterator!";
	//testQuantity();
}
